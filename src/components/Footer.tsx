...
const Footer: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Se rolou mais de 100px, esconde o rodapé flutuante
    ...
    <>
      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            <li>
              <a href="https://busca.rapport.tec.br" target="_blank" rel="noopener noreferrer" className="footer-link">
                GenAI Search
              </a>
            </li>
            <li>
